...
// Action to add menu
add_action('admin_menu', 'wpnwm_register_design_page');
 ...
 * @since 1.0.0
 */
function wpnwm_register_design_page() {
	add_submenu_page( 'edit.php?post_type='.WPNW_POST_TYPE, __('How it works, our plugins and offers', 'sp-news-and-widget'), __('How It Works', 'sp-news-and-widget'), 'manage_options', 'wpnwm-designs', 'wpnwm_designs_page' );
}
...
function wpnwm_designs_page() {
	...
	$wpos_feed_tabs = wpnwm_help_tabs();
	...
	<div class="wrap wpnwm-wrap">
		...
		<h2 class="nav-tab-wrapper">
			...
			foreach ($wpos_feed_tabs as $tab_key => $tab_val) {
				...
				$tab_link 	= add_query_arg( array( 'post_type' => WPNW_POST_TYPE, 'page' => 'wpnwm-designs', 'tab' => $tab_key), admin_url('edit.php') );
			?>
		...
		<?php
			if( isset($active_tab) && $active_tab == 'how-it-work' ) {
				wpnwm_howitwork_page();
			}
			else if( isset($active_tab) && $active_tab == 'plugins-feed' ) {
				echo wpnwm_get_plugin_design( 'plugins-feed' );
			} else {
				echo wpnwm_get_plugin_design( 'offers-feed' );
			}
		?>
 ...
 * @since 1.0.0
 */
function wpnwm_get_plugin_design( $feed_type = '' ) {
